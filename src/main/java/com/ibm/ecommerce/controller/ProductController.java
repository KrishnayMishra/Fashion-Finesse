...
/**
 * 
 * I have mapped various routes for Product Entity in which we are adding new product(authorised by admin), fetching product details and deleting product details 
 *(authorised by admin).
 */
@RestController
